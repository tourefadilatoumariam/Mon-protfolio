<template>
  <div class="font-sans bg-[#0e0c0d] text-white overflow-x-hidden relative">
    ...
    <button
      ...
      class="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-40 flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 rounded-full bg-rose text-[#0e0c0d] font-bold text-xs sm:text-sm shadow-xl shadow-rose/20 hover:bg-rose2 hover:-translate-y-0.5 active:scale-95 transition-all no-print animate-pulse-slow safe-bottom"
    ...
    >
      ...
      <span class="hidden xs:inline">Mon CV</span>
    </button>
